<x-bladewright::layout :title="$part->name" :subtitle="$part->type">
    <x-slot:actions>
        <x-bladewright::icon-link :href="route('bladewright.admin.components.settings', $part)" :tip="__('Component settings')">
    ...
    <livewire:bladewright::component-editor :component="$part" :key="'component-'.$part->id" />
