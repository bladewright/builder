<x-bladewright::layout :title="$part->name" :subtitle="__('Layout settings')">
    <x-slot:actions>
        <a href="{{ route('bladewright.admin.layouts.edit', $part) }}"
    ...
    <div class="w-full">
        <livewire:bladewright::layout-settings :layout="$part" :key="'layout-settings-'.$part->id" />
    </div>
