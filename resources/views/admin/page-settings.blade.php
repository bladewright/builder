<x-bladewright::layout :title="$page->name" :subtitle="__('Page settings')">
    <x-slot:actions>
        <a href="{{ route('bladewright.admin.pages.edit', $page) }}"
    ...
    <div class="w-full">
        <livewire:bladewright::page-settings :page="$page" :key="'page-settings-'.$page->id" />
    </div>
