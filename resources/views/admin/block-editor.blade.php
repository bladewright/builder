<x-bladewright::layout :title="$block->name" :subtitle="$block->type">
    <x-slot:actions>
        <x-bladewright::icon-link :href="route('bladewright.admin.blocks.settings', $block)" :tip="__('Block settings')">
    ...
    <livewire:bladewright::block-editor :block="$block" :key="'block-'.$block->id" />
